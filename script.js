...
// Observe all feature cards, car cards, benefit items, and invest pillars
document.querySelectorAll('.feature-card, .car-card, .benefit-item, .stat-item, .forest-card, .invest-pillar').forEach(el => {
    observer.observe(el);
});
...
function addScrollToTop() {
    ...
    scrollToTopBtn.addEventListener('mouseenter', () => {
        ...
        scrollToTopBtn.style.background = 'linear-gradient(135deg, #16A34A 0%, #22C55E 100%)';
    });
    
    scrollToTopBtn.addEventListener('mouseleave', () => {
        scrollToTopBtn.style.transform = 'scale(1)';
        scrollToTopBtn.style.background = 'linear-gradient(135deg, #22C55E 0%, #16A34A 100%)';
    });
}
